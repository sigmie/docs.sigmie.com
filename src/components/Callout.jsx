...
const styles = {
  note: {
    container:
      'bg-orange-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10',
    title: 'text-orange-900 dark:text-orange-400',
    body: 'text-orange-800 [--tw-prose-background:theme(colors.orange.50)] prose-a:text-orange-900 prose-code:text-orange-900 dark:text-slate-300 dark:prose-code:text-slate-300',
  },
  warning: {
    container:
