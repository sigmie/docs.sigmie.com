...
![Vue JS Example](https://res.cloudinary.com/markos-nikolaos-orfanos/video/upload/c_crop/v1675777019/documentation/CleanShot_2023-02-07_at_15.36.02_j2lzwo.gif "Sigmie React JS")


We provide a **Frontend** Vue JS library that integrates nicely with
[HeadlessUI](https://headlessui.com/) by [Tailwind](https://tailwindcss.com/).
## Installation

To get started, install Headless UI and Sigmie Vue via npm:

```sh
npm install -D @headlessui/vue @sigmie/vue @heroicons/vue
```

## Example

Here the above is an example to get you started:
