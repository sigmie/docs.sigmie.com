module.exports = {
  ...
  head: [
    ...
    [
      "link",
      { rel: "mask-icon", href: "/logo-elevated.svg", color: "#3eaf7c" },
    ],
    ...
    [
      "meta",
      { name: "msapplication-TileImage", content: "/manifest-icon-192.png" },
    ],
    ...
    [
      "meta",
      { name: "apple-mobile-web-app-status-bar-style", content: "#202327" },
    ],
